...
parseInstruction b =
  ...
  in
    ...
    (0,3,0) -> o JP   [ AddressRel ]
    (0,y,0) -> o JP   [ ArgFlag $! flag y, AddressRel ]
    ...
    (0,y@0,2) -> o LD [ ArgDirect8 A, registerPointerArg y ]
    (0,y@2,2) -> o LD [ ArgDirect8 A, registerPointerArg y ]
    (0,y@4,2) -> o LD [ ArgDirect8 A, registerPointerArg y ]
    (0,y@6,2) -> o LD [ ArgDirect8 A, registerPointerArg y ]

    (0,y@1,2) -> o LD [ registerPointerArg y, ArgDirect8 A ]
    (0,y@3,2) -> o LD [ registerPointerArg y, ArgDirect8 A ]
    (0,y@5,2) -> o LD [ registerPointerArg y, ArgDirect8 A ]
    (0,y@7,2) -> o LD [ registerPointerArg y, ArgDirect8 A ]
